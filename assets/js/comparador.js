...
function renderChart(canvasEl, datas, seriePorAtivo, idsSelecionados, totalInvestidoSerie) {
  ...
  datasets.push({
    ...
    borderColor: "rgba(215,220,229,0.45)", // tom próximo de --text-secondary (#D7DCE5), bem mais fraco que os ativos — linha de referência, não uma série concorrendo visualmente
    backgroundColor: COR_TOTAL_INVESTIDO,
    pointBackgroundColor: COR_TOTAL_INVESTIDO,
    borderDash: [6, 4], // tracejado mais evidente que o dos ativos (que não têm dash nenhum)
    borderWidth: 1,
    pointRadius: 0,
    fill: false,
    tension: 0,
